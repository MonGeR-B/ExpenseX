        ...
        <MobileContainer>
            <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
                ...
                <View className="px-6" style={{ paddingHorizontal: 24 }}>
                    ...
                    <MobileCard className="p-0 overflow-hidden mb-6 border-0" style={{ padding: 0, overflow: 'hidden', marginBottom: 24, borderWidth: 0 }}>
                        <LinearGradient
                    ...
                    {/* Settings Groups */}
                    <MobileCard className="p-5 mb-6" style={{ padding: 20, marginBottom: 24 }}>
                        <Text className="text-slate-900 font-bold text-lg mb-4" style={{ color: '#0f172a', fontWeight: 'bold', fontSize: 18, marginBottom: 16 }}>General</Text>
                        ...
                        <Pressable onPress={() => router.push("/categories")} className="flex-row items-center py-3 border-b border-slate-50 mb-2" style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#f8fafc', marginBottom: 8 }}>
                            ...
                            <Text className="text-slate-700 font-medium flex-1 text-base" style={{ color: '#334155', fontWeight: '500', flex: 1, fontSize: 16 }}>Categories</Text>
                        ...
                        <View className="flex-row items-center py-3" style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 12 }}>
                            ...
                            <Text className="text-slate-700 font-medium flex-1 text-base" style={{ color: '#334155', fontWeight: '500', flex: 1, fontSize: 16 }}>Push Notifications</Text>
                            <Switch value={true} trackColor={{ false: "#e2e8f0", true: "#3b82f6" }} thumbColor="white" />
                        </View>
                    </MobileCard>

                    <MobileCard className="p-5 mb-6" style={{ padding: 20, marginBottom: 24 }}>
                        <Text className="text-slate-900 font-bold text-lg mb-4" style={{ color: '#0f172a', fontWeight: 'bold', fontSize: 18, marginBottom: 16 }}>Data</Text>
                        <View className="flex-row gap-4" style={{ flexDirection: 'row', gap: 16 }}>
                            <Pressable className="flex-1 bg-slate-50 py-4 rounded-2xl items-center border border-slate-100" style={{ flex: 1, backgroundColor: '#f8fafc', paddingVertical: 16, borderRadius: 16, alignItems: 'center', borderWidth: 1, borderColor: '#f1f5f9' }}>
                                ...
                                <Text className="text-slate-600 font-bold text-sm" style={{ color: '#475569', fontWeight: 'bold', fontSize: 14 }}>Export CSV</Text>
                            </Pressable>
                            <Pressable className="flex-1 bg-slate-50 py-4 rounded-2xl items-center border border-slate-100" style={{ flex: 1, backgroundColor: '#f8fafc', paddingVertical: 16, borderRadius: 16, alignItems: 'center', borderWidth: 1, borderColor: '#f1f5f9' }}>
                                <Upload size={24} color="#64748b" style={{ marginBottom: 8 }} />
                                <Text className="text-slate-600 font-bold text-sm" style={{ color: '#475569', fontWeight: 'bold', fontSize: 14 }}>Import Data</Text>
                            </Pressable>
                        </View>
                    </MobileCard>

                    <MobileCard className="p-0 overflow-hidden bg-red-50 border-red-100" style={{ padding: 0, overflow: 'hidden', backgroundColor: '#fef2f2', borderColor: '#fee2e2' }}>
